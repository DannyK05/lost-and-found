...
export function SideContainer({ type, children, isVisible, toggleContainer }) {
  return (
    <div
      ...
      }  bg-white fixed transition-50 shadow-lg w-full md:w-3/5 lg:w-1/2 px-4 py-2 rounded-lg border-md top-[76px] lg:top-[0] md:top-[100px] lg:h-screen h-[95vh] z-[10000] right-0`}
    >
